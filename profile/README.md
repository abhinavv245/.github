...
|                       | Marine Insurance   | [cornex.in](https://cornex.in)                                                                    | Fill onboarding form or Email "avijeet@cornex.in" for onboarding.                                                       | *Information will soon be updated*            | *Information will soon be updated*                                                   |
|                       | Motor Insurance    | [cornex.in](https://cornex.in)                                                                    | Fill onboarding form or Email "avijeet@cornex.in" for onboarding.                                                       | *Information will soon be updated*            | *Information will soon be updated*                                                   |
|                       | Health Insurance   | [credit.staging.cliniq360.com](https://credit.staging.cliniq360.com/)                             | Email "dev@cliniq360.com" to get the login credentials                                                                   | *Information will soon be updated*            | *Information will soon be updated*                                                   |
| Mobility             | Ride Hailing       | *Information will soon be updated*                                                                | *Information will soon be updated*                                                                                      | *Information will soon be updated*            | *Information will soon be updated*                                                   |
|                       | Metro              | *Information will soon be updated*                                                                | *Information will soon be updated*                                                                                      | *Information will soon be updated*            | *Information will soon be updated*                                                   |
| B2B                  | Retail             | [Google Play Store Link](https://play.google.com/store/apps/details?id=com.placeorder.app.referance.preprod&pcampaignid=web_share) | Email "sanu.shilshad@acelrtech.com" OR "vishnudas.kt@acelrtech.com" to get the login details.                            | ondcsellerstagingref.rapidor.co               | Email "sanu.shilshad@acelrtech.com" OR "vishnudas.kt@acelrtech.com" to get the login details. |
| B2C                  | Logistics          | -                                                                                                  | *Information will soon be updated*                                                                                      | [ref-logistics-staging.thewitslab.com](https://ref-logistics-staging.thewitslab.com/) | Email "ishan.dutta@thewitslab.com" to get the login credentials.                       |
| B2C                  | Retail             | [ref-app-buyer-staging-v2.ondc.org](https://ref-app-buyer-staging-v2.ondc.org/login)              | Email "techsupport@ondc.org" to get the required support.                                                                | [ref-app-seller-staging-v2.ondc.org](https://ref-app-seller-staging-v2.ondc.org/sign-up) | Email "techsupport@ondc.org" to get the required support.                              |
...
| Mobility             | Ride Hailing       | *Information will soon be updated*                                                                | *Information will soon be updated*                                                                                      | *Information will soon be updated*            | *Information will soon be updated*                                                   |
|                       | Metro              | *Information will soon be updated*                                                                | *Information will soon be updated*                                                                                      | *Information will soon be updated*            | *Information will soon be updated*                                                   |
| B2B                  | Retail             | [Google Play Store Link](https://play.google.com/store/apps/details?id=com.placeorder.app.referance.preprod&pcampaignid=web_share) | Email "sanu.shilshad@acelrtech.com" OR "vishnudas.kt@acelrtech.com" to get the login details.                            | ondcsellerpreprodref.rapidor.co               | Email "sanu.shilshad@acelrtech.com" OR "vishnudas.kt@acelrtech.com" to get the login details. |
| B2C                  | Logistics          | -                                                                                                  | *Information will soon be updated*                                                                                      | [wits-ref-logistics-app.thewitslab.com](https://wits-ref-logistics-app.thewitslab.com/) | Email "ishan.dutta@thewitslab.com" to get the login credentials.                       |
| B2C                  | Retail             | [buyer-app-preprod-v2.ondc.org](https://buyer-app-preprod-v2.ondc.org/login)                      | Email "techsupport@ondc.org" to get the required support.                                                                | [seller-app-preprod-v2.ondc.org](https://seller-app-preprod-v2.ondc.org/sign-up)        | Email "techsupport@ondc.org" to get the required support.                              |
