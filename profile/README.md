...
|                       | Marine Insurance     | [cornex.in](https://cornex.in)                                                             | Fill onboarding form or email **avijeet@cornex.in** for onboarding.                                                       | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | Email the following details to **Mrityunjay** (CC **Amit** and **Nirdosh**) for access: Email ID, Subscriber ID, NP Mobile Number, Role, and Environment.                   |
|                       | Motor Insurance      | [cornex.in](https://cornex.in)                                                             | Fill onboarding form or email **avijeet@cornex.in** for onboarding.                                                       | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | Email the following details to **Mrityunjay** (CC **Amit** and **Nirdosh**) for access: Email ID, Subscriber ID, NP Mobile Number, Role, and Environment.                   |
|                       | Health Insurance     | [credit.staging.cliniq360.com](https://credit.staging.cliniq360.com/)                       | Email **dev@cliniq360.com** to get the login credentials.                                                                  | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | Email the following details to **Mrityunjay** (CC **Amit** and **Nirdosh**) for access: Email ID, Subscriber ID, NP Mobile Number, Role, and Environment.                   |
| Mobility              | Ride Hailing         | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/gui/buyer)    | Email the following details to **Mrityunjay** (CC **Amit** and **Nirdosh**) for access: Email ID, Subscriber ID, NP Mobile Number, Role, and Environment.         | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | Email the following details to **Mrityunjay** (CC **Amit** and **Nirdosh**) for access: Email ID, Subscriber ID, NP Mobile Number, Role, and Environment.                   |
|                       | Metro                | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/gui/buyer)    | Email the following details to **Mrityunjay** (CC **Amit** and **Nirdosh**) for access: Email ID, Subscriber ID, NP Mobile Number, Role, and Environment.         | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | Email the following details to **Mrityunjay** (CC **Amit** and **Nirdosh**) for access: Email ID, Subscriber ID, NP Mobile Number, Role, and Environment.                   |
...
|                       | Motor Insurance      | [cornex.in](https://cornex.in)                                                             | Fill onboarding form or Email "avijeet@cornex.in" for onboarding.                                                                                                                                                                                                                                                                                             | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | Same process as Marine Insurance.                                                                                                                                                                                                                                                                                                                             |
|                       | Health Insurance     | [credit.staging.cliniq360.com](https://credit.staging.cliniq360.com/)                       | Email "dev@cliniq360.com" to get the login credentials.                                                                                                                                                                                                                                                                                                       | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | Same process as Marine Insurance.                                                                                                                                                                                                                                                                                                                             |
| Mobility              | Ride Hailing         | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/gui/buyer)    | Same process as Marine Insurance.                                                                                                                                                                                                                                                                                                                             | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | Same process as Marine Insurance.                                                                                                                                                                                                                                                                                                                             |
|                       | Metro                | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/gui/buyer)    | Same process as Marine Insurance.                                                                                                                                                                                                                                                                                                                             | [ondc-ref-app.sequelstring.com](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | Same process as Marine Insurance.                                                                                                                                                                                                                                                                                                                             |
| B2B                   | Retail               | [play.google.com/store/apps/details](https://play.google.com/store/apps/details?id=com.placeorder.app.referance.preprod&pcampaignid=web_share) | Email "sanu.shilshad@acelrtech.com" OR "vishnudas.kt@acelrtech.com" to get the login details.<br>Support Contact:<br>- Name: Sanu Shilshad<br>- Email: sanu.shilshad@acelrtech.com<br>- Phone: +91-9562279968                                                                                                                                                    | ondcsellerstagingref.rapidor.co                                                           | Same process as Buyer App.                                                                                                                                                                                                                                                                                                                                      |
| B2C                   | Logistics            | -                                                                                           | -                                                                                                                                                                                                                                                                                                                                                              | [ref-logistics-staging.thewitslab.com](https://ref-logistics-staging.thewitslab.com/)     | Email "ishan.dutta@thewitslab.com" to get the login credentials.                                                                                                                                                                                                                                                                                               |
| B2C                   | Retail               | [ref-app-buyer-staging-v2.ondc.org](https://ref-app-buyer-staging-v2.ondc.org/login)        | Email "techsupport@ondc.org" to get the required support.                                                                                                                                                                                                                                                                                                      | [witslab-bpp-staging.thewitslab.com](https://witslab-bpp-staging.thewitslab.com)         | Email "ishan.dutta@thewitslab.com" to get the login credentials.                                                                                                                                                                                                                                                                                               |
>>>>>>> 4ac82447b04c64fe19cfc0270ea40476ea5d4a6a

## Pre-prod

| Domain               | Use case          | Buyer App URL                                                    | Onboarding Process/Point of Contact                                                                                                       | Seller App URL                                                    | Onboarding Process/Point of Contact                                                                                                       |
|-----------------------|-------------------|------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| Financial Services   | Personal Loan     | https://credit.staging.cliniq360.com/                           | Email "dev@cliniq360.com" to get the login credentials.                                                                                    | ondc.fis12.seller.cornex.in                                      | Fill onboarding form or Email "avijeet@cornex.in" for onboarding.                                                                        |
|                       | Invoice based loan| https://cornex.in                                               | Fill onboarding form or Email "avijeet@cornex.in" for onboarding.                                                                         | ondc.fis12.seller.cornex.in                                      | Fill onboarding form or Email "avijeet@cornex.in" for onboarding.                                                                        |
|                       | Marine Insurance  | https://cornex.in                                               | Fill onboarding form or Email "avijeet@cornex.in" for onboarding.                                                                         | https://ondc-ref-app.sequelstring.com/preprod/mock/seller        | Process for NP to access the environment: Please send the required info via email to Mrityunjay (cc amit, nirdosh). Sequelstring will assist. |
|                       | Motor Insurance   | https://cornex.in                                               | Fill onboarding form or Email "avijeet@cornex.in" for onboarding.                                                                         | https://ondc-ref-app.sequelstring.com/preprod/mock/seller        | Process for NP to access the environment: Please send the required info via email to Mrityunjay (cc amit, nirdosh). Sequelstring will assist. |
|                       | Health Insurance  | https://credit.staging.cliniq360.com/                           | Email "dev@cliniq360.com" to get the login credentials.                                                                                    | https://ondc-ref-app.sequelstring.com/preprod/mock/seller        | Process for NP to access the environment: Please send the required info via email to Mrityunjay (cc amit, nirdosh). Sequelstring will assist. |
| Mobility             | Ride Hailing      | https://ondc-ref-app.sequelstring.com/preprod/gui/buyer          | Process for NP to access the environment: Please send the required info via email to Mrityunjay (cc amit, nirdosh). Sequelstring will assist. | https://ondc-ref-app.sequelstring.com/preprod/mock/seller        | Process for NP to access the environment: Please send the required info via email to Mrityunjay (cc amit, nirdosh). Sequelstring will assist. |
|                       | Metro             | https://ondc-ref-app.sequelstring.com/preprod/gui/buyer          | Process for NP to access the environment: Please send the required info via email to Mrityunjay (cc amit, nirdosh). Sequelstring will assist. | https://ondc-ref-app.sequelstring.com/preprod/mock/seller        | Process for NP to access the environment: Please send the required info via email to Mrityunjay (cc amit, nirdosh). Sequelstring will assist. |
...
| B2C                  | Logistics         | -                                                                | -                                                                                                                                          | https://wits-ref-logistics-app.thewitslab.com/                   | Email "ishan.dutta@thewitslab.com" to get the login credentials.                                                                          |
|                       | Retail            | https://buyer-app-preprod-v2.ondc.org/login                      | Email "techsupport@ondc.org" to get the required support.                                                                                 | https://seller-app-preprod-v2.ondc.org/sign-up                   | Email "ishan.dutta@thewitslab.com" to get the login credentials.                                                                          |
