...
| Domain  | Service Type | Buyer App                                                      | Onboarding Process/Point of Contact                                                                                   | Seller App                       | Onboarding Process/Point of Contact                                                                                       |
|---------|--------------|---------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|----------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| B2B     | Retail       | [https://play.google.com/store/apps/details?id=com.placeorder.app.referance.preprod&pcampaignid=web_share](https://play.google.com/store/apps/details?id=com.placeorder.app.referance.preprod&pcampaignid=web_share) | Email "sanu.shilshad@acelrtech.com" OR "vishnudas.kt@acelrtech.com" to get the login details. Support Contact from Acelr Tech Labs Pvt. Ltd. (Rapidor) <ul><li>Name: Sanu Shilshad</li><li>Email: sanu.shilshad@acelrtech.com</li><li>Phone: +91-9562279968</li></ul> | ondc.sellerstagingref.rapidor.co | Email "sanu.shilshad@acelrtech.com" OR "vishnudas.kt@acelrtech.com" to get the login details. |
...
| Domain     | Service Type     | Buyer App                                                     | Onboarding Process/Point of Contact                                                                                                                                           | Seller App                       | Onboarding Process/Point of Contact                                                                                       |
|------------|------------------|--------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| Mobility   | Ride Hailing     | [https://ondc-ref-app.sequelstring.com/preprod/gui/buyer](https://ondc-ref-app.sequelstring.com/preprod/gui/buyer) | Process for NP to access the environment: <br> Please send the following info on email, please write to Mrityunjay and keep amit and nirdosh in cc: <ul><li>Email ID</li><li>Subscribe ID</li><li>NP Mobile Number</li><li>Role: BPP/BAP</li><li>Environment: Staging/Preprod</li></ul> Once Sequelstring receive the details, Sequelstring will assign a resource from our team who will be responsible for coordination and ensuring the success of the NP throughout their journey with our solutions. | [https://ondc-ref-app.sequelstring.com/staging/mock/seller](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | For Support, please refer to the details below: <br> **Mrityunjay Kumar** <ul><li>Phone Number: 9650254390</li><li>Email: mrityunjay.kumar@sequelstring.com</li></ul> **Nirdosh** <ul><li>Phone Number: 9058626929</li><li>Email: nirdosh.kumar@sequelstring.com</li></ul> **Amit** <ul><li>Phone Number: 9130057257</li><li>Email: amit.sharma@sequelstring.com</li></ul>  |
|            | Metro            | [https://ondc-ref-app.sequelstring.com/preprod/gui/buyer](https://ondc-ref-app.sequelstring.com/preprod/gui/buyer) | Process for NP to access the environment: <br> Please send the following info on email, please write to Mrityunjay and keep amit and nirdosh in cc: <ul><li>Email ID</li><li>Subscribe ID</li><li>NP Mobile Number</li><li>Role: BPP/BAP</li><li>Environment: Staging/Preprod</li></ul> Once Sequelstring receive the details, Sequelstring will assign a resource from our team who will be responsible for coordination and ensuring the success of the NP throughout their journey with our solutions. | [https://ondc-ref-app.sequelstring.com/staging/mock/seller](https://ondc-ref-app.sequelstring.com/staging/mock/seller) | For Support, please refer to the details below: <br> **Mrityunjay Kumar** <ul><li>Phone Number: 9650254390</li><li>Email: mrityunjay.kumar@sequelstring.com</li></ul> **Nirdosh** <ul><li>Phone Number: 9058626929</li><li>Email: nirdosh.kumar@sequelstring.com</li></ul> **Amit** <ul><li>Phone Number: 9130057257</li><li>Email: amit.sharma@sequelstring.com</li></ul>  |
...
| Domain  | Service Type | Buyer App                                                      | Onboarding Process/Point of Contact                                                                                   | Seller App                       | Onboarding Process/Point of Contact                                                                                       |
|---------|--------------|---------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|----------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| B2C     | Logistics    | -                                                             | [https://ref-logistics-preprod.thewitslab.com/](https://ref-logistics-preprod.thewitslab.com/) | Email "ishan.dutta@thewitslab.com" to get the login credentials.                                                                  | -                                | -                                                                                                                         |
|         | Retail       | [https://ref-app-buyer-preprod-v2.ondc.org/login](https://ref-app-buyer-preprod-v2.ondc.org/login)   | Email "techsupport@ondc.org" to get the required support. | [https://ref-app-seller-preprod-v2.ondc.org/sign-up](https://ref-app-seller-preprod-v2.ondc.org/sign-up) | Email "techsupport@ondc.org" to get the required support.                                                                  |
